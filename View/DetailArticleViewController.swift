...
//        }
    ...
    @IBAction func addToFavourite(_ sender: UIButton) {
                if isActive {
                    isActive = false
                    guard let url = URL(string: "https://backend-showapp.herokuapp.com/favorites/"+article!._id+"/"+UserDefaults.standard.string(forKey: "_id")!) else {
        ...
        sender.setImage(UIImage(named: "whiteHeart"), for: .normal)
                ...
                guard let url = URL(string: "https://backend-showapp.herokuapp.com/favorites/add") else {
                            fatalError("Error getting the url")
                        }
