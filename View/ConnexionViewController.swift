...
class ConnexionViewController: UIViewController, LoginButtonDelegate {
    ...
    func LoginUser(email: String, password: String) {
        guard let url = URL(string: "http://192.168.1.15:3000/users/login") else {
...
//                        UserDefaults.standard.setValue(response["userId"]!, forKey: "userId")
    ...
    func LoginCompany(email: String, password: String) {
        guard let url = URL(string: "http://192.168.1.15:3000/company/login") else {
            fatalError("Error getting the url")
        }
        let params: Parameters = [
...
//    func fetchData() {
//        guard let url = URL(string: "http://192.168.1.15:3000/users") else { return}
...
//        guard let url = URL(string: "http://192.168.1.15:3000/company") else { return}
//        let session = URLSession.shared.dataTask(with: url) {
//            data, response, error in
//            if let error = error {
//                print("There was an error: \(error.localizedDescription)")
