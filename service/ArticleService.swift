...
class articleService {
    ...
    static func addArticleToServer(image: UIImage,parameters:[String:Any]) {
       ...
       guard let url = URL(string: "http://192.168.1.23:3000/articles") else { return }
    ...
    func getArticleByType(ArticleType:String ,callback: @escaping (Bool,Articles?)->Void){
        ...
        guard let url = URL(string: "http://192.168.1.23:3000/articles/type/"+ArticleType) else{
                return
            }
            var request = URLRequest(url: url)
    ...
    func getArticle( callback: @escaping (Bool,Articles?)->Void){
            ...
            guard let url = URL(string: "http://192.168.1.23:3000/articles") else{
                return
            }
            var request = URLRequest(url: url)
            request.httpMethod = "GET"
    ...
    func getCompanyArticle( callback: @escaping (Bool,Articles?)->Void){
            ...
            guard let url = URL(string: "http://192.168.1.23:3000/articles/company/" + UserDefaults.standard.string(forKey: "_id")!) else{
                return
            }
            var request = URLRequest(url: url)
            request.httpMethod = "GET"
    ...
    func getBrandArticle(BrandId:String, callback: @escaping (Bool,Articles?)->Void){
            ...
            guard let url = URL(string: "http://192.168.1.23:3000/articles/company/"+BrandId ) else{
                return
            }
            var request = URLRequest(url: url)
            request.httpMethod = "GET"
    ...
    static func addArticleToFavourit(image: UIImage,parameters:[String:Any]) {
       ...
       guard let url = URL(string: "http://192.168.1.23:3000/favorites/add") else { return }
       var request = URLRequest(url: url)
       request.httpMethod = "POST"
       //create boundary
       let boundary = generateBoundary()
    ...
    func getUserFavourites( callback: @escaping (Bool,Favorites?)->Void){
        ...
        guard let url = URL(string: "http://192.168.1.23:3000/favorites/refuser/"+UserDefaults.standard.string(forKey: "_id")!) else{
                    return
                }
                var request = URLRequest(url: url)
                request.httpMethod = "GET"
    ...
    func getUserCarts( callback: @escaping (Bool,Factures?)->Void){
        ...
        guard let url = URL(string: "http://192.168.1.23:3000/factures/refuser/"+UserDefaults.standard.string(forKey: "_id")!) else{
                    return
                }
                var request = URLRequest(url: url)
                request.httpMethod = "GET"
